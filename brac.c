...
void mechanicalArm() {
	//Definindo cor do primeiro objeto
  

	//PRIMEIRA PARTIÇÃO(BRAÇO TODO)
	//Criando a esfera base
	glColor3ub(0, 0, 100);
	...
	//SEGUNDA PARTIÇÃO DO BRAÇO
	glColor3ub(0, 0, 100);
	glTranslatef(7,0,0);
	glutSolidSphere(1,20,20);
	//Roda as duas partições 
	...
	glTranslatef(7,0,0);
	glutSolidSphere(1,20,20);
	//Roda apenas a ultima partição
	glRotatef(angulo3, 0.0, 0.0, 1.0);
